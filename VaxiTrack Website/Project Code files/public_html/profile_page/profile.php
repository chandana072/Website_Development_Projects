...
<body class="bd">
        <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="#"><b>Welcome <?php if(!isset($_SESSION)){ session_start(); } echo $_SESSION['username'];?></b></a>
        ...
        <div class="grid-container">  
            <div class="row">
                ...
                <div class="col-12 align-self-end" id="table">
                    <h2 class="text-danger"><b> Vaccination Schedule   </b>
                    </h2>
    ...
    <div class="footer text-center pt-0">
            <p> Copyright<i class="fa fa-copyright" aria-hidden="true"></i> 2020 | Vaccine Management System<br> Contact For Appointment +919999999999 </br></p>
            </div>
</body>
</html>